...
def spotify
  ...
  recommendations = RSpotify::Recommendations.generate(limit: 21, seed_tracks: [@tracks[0].id], seed_artists: [@tracks[1].artists[0].id], seed_genres: [@tracks[2].artists[0].genres[0]])
